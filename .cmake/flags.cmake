...
if(MSVC)
	...
	set(STRICT_OPTIONS_CXX "${STRICT_OPTIONS_CXX} -std=c++14 -Og")
	...
	if (CMAKE_BUILD_TYPE STREQUAL "Debug")
		...
		set(STRICT_OPTIONS_C "${STRICT_OPTIONS_C} -Og -g -rdynamic")
	endif()
	set(STRICT_OPTIONS_C "${STRICT_OPTIONS_C} -std=c11 -Wno-error=strict-prototypes -funroll-loops -Wno-error=implicit-function-declaration -Wno-error=attributes")
